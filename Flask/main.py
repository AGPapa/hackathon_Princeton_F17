...
#    print(subject)
    ...
    if (intent == "Thank you"):
        ...
        if (subject == "Blank"):
            ...
            search = ["Here's some information that might help."] + runSearch(entity, subject)
            return search
        ...
        if (subject == "Blank"):
            ...
            search = ["Here's some resources for you."] + runSearch(entity + " practice problems", subject)
            return search
            for result in search:
                print(result["title"] + ": " + result["url"])
